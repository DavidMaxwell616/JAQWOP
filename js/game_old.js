var game = new Phaser.Game(CANVAS_WIDTH, 500, Phaser.BOX2D, 'phaser-example', 
...
function resetJack() {
    ...
    ur_arm = createBox(START_X-15, START_Y-48, 20, 20, 0, false, 0.1,collisionType);
    lr_arm = createBox(START_X-10, START_Y-85, 20, 40, 0, false, 0.1,collisionType);
    ul_arm = createBox(START_X-15, START_Y-48, 20, 20, 0, false, 0.1,collisionType);
    ll_arm = createBox(START_X-10, START_Y-85, 20, 40, 0, false, 0.1,collisionType);
    ul_leg = createBox(START_X-2,START_Y-116,1,40,Math.PI/6,false,10,collisionType);
    ll_leg = createBox(START_X-2,START_Y-144,5,40,-Math.PI/6,false,10,collisionType);
    ur_leg = createBox(START_X-2,START_Y-116,15,40,Math.PI/6,false,10,collisionType);
    lr_leg = createBox(START_X-2,START_Y-144,5,40,-Math.PI/6,false,10,collisionType);
