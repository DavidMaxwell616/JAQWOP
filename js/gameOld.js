...
var CANVAS_WIDTH = 1024, CANVAS_HEIGHT = 600, SCALE = 30;
...
rightArmImage.src = "assets/jackrarm.png";
var leftArmImage = new Image();
leftArmImage.src = "assets/jacklarm.png";
var bodyImage = new Image();
bodyImage.src = "assets/jackbody.png";
var thighImage = new Image();
thighImage.src = "assets/jackthigh.png";
var legImage = new Image();
legImage.src = "assets/jackleg.png";
var headImage = new Image();
headImage.src = "assets/jackhead.png";
var bkgdImage = new Image();
bkgdImage.src = "assets/background.JPG";
...
function resetRunner() {
    ...
    var r_arm = createBox(world, 240, 126, 40, 8, 0, false, 0.1);
...
function mainLoop() {
    ...
    if (!mainLoopPaused) {
        ...
        ctx.fillText('Best Distance: ' + round(farthestDistTraveled) + ' m', 98, 48);
        // ctx.fillText('Time Elapsed: ' + Math.round(elapsedTime*10)/10 + ' s',100,100);
        ctx.fillText('Total Distance: ' + round(totalDistTraveled) + ' m', 98, 98);
        // ctx.fillText('Velocity: ' + Math.round(10*curVelX)/10 + ' m/s',100,200);
        ctx.fillText('Keystate: ' + action_strings[keyState], 98, 148);
